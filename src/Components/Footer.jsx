...
function Footer() {
  ...
  const handleDonateLinkClick = () => {
    // Navigate to About page and scroll to donation section
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li>
                <Link to="/privacy" className="text-gray-300 hover:text-white transition-all duration-200 text-sm flex items-center space-x-3 group">
                  <div className="p-1.5 rounded-lg bg-gray-800 group-hover:bg-gray-700 transition-colors duration-200">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <li>
                <Link to="/terms" className="text-gray-300 hover:text-white transition-all duration-200 text-sm flex items-center space-x-3 group">
                  <div className="p-1.5 rounded-lg bg-gray-800 group-hover:bg-gray-700 transition-colors duration-200">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
